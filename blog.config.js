...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'academic.levibest.online', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'levibestonline@outlook.com', // 邮箱地址 例如mail@tangly1024.com
